<div>
    <x-dropdown width="96">
        ...
        <x-slot name="content">
            ...
            @if (Cart::count())
                <div class="py-2 px-3">
                    <p class="text-lg text-gray-700 mt-2 mb-3"><span class="font-bold">Total: USD</span> {{Cart::subtotal()}}</p>

                    <x-button-enlace href="{{ route('shopping-cart') }}" class="w-full">Ir al carrito de compras</x-button-enlace>
                </div>
            @endif
